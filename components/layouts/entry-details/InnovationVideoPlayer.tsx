...
export default function InnovationVideoPlayer({ videoId, colors }: InnovationVideoPlayerProps) {
  ...
  return (
    <Box sx={{ mb: 5 }}>
      ...
      <Box sx={{ width: "100%", aspectRatio: "16/9", borderRadius: 4, overflow: 'hidden', boxShadow: "0 10px 40px -10px rgba(0,0,0,0.1)", border: `1px solid ${colors.BORDER}` }}>
        <iframe
          width="100%"
          height="100%"
